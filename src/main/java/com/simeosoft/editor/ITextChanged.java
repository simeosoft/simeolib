...
/**
 * TextListener objects are used to control the text changes in a cell.
 * 
 * <br>$Id: ITextChanged.java 21 2007-09-05 16:13:25Z mauro $
 */
public interface ITextChanged {
    
    /**
     * @param oldText the original text
     * @param newText the newly edited text 
